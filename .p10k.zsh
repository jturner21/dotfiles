# Generated by Powerlevel10k configuration wizard on 2024-06-08 at 11:49 CDT.
# Based on romkatv/powerlevel10k/config/p10k-classic.zsh, checksum 02750.
# Wizard options: powerline, classic, ascii, dark, 12h time, 2 lines, dotted, sparse,
...
() {
  ...
  typeset -g POWERLEVEL9K_VPN_IP_INTERFACE='(gpd|wg|(.*tun0)|tailscale)[0-9]*|(zt.*)'
